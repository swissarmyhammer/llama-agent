...
async fn test_cli_argument_parsing() {
    ...
    let test_cases = vec![
        ...
        vec!["--model", "microsoft/DialoGPT-medium", "--filename", "model.gguf", "--prompt", "hello"],
        vec!["--model", "./models", "--prompt", "hello", "--limit", "100"],
        vec!["--model", "./models", "--prompt", "hello", "--batch-size", "256"],
        vec!["--model", "./models", "--prompt", "hello", "--max-queue-size", "20"],
        vec!["--model", "./models", "--prompt", "hello", "--request-timeout", "60"],
        vec!["--model", "./models", "--prompt", "hello", "--worker-threads", "2"],
        vec!["--model", "./models", "--prompt", "hello", "--max-sessions", "50"],
        vec!["--model", "./models", "--prompt", "hello", "--session-timeout", "7200"],
        vec!["--model", "./models", "--prompt", "hello", "--temperature", "0.8"],
        vec!["--model", "./models", "--prompt", "hello", "--top-p", "0.95"],
        vec![
            "--model", "./models",
            "--filename", "model.gguf",
...
async fn test_cli_invalid_argument_values() {
    let test_cases = vec![
        ...
        (vec!["--model", "test", "--prompt", "hello", "--limit", "abc"], "limit"),
        (vec!["--model", "test", "--prompt", "hello", "--batch-size", "-1"], "batch"),
        (vec!["--model", "test", "--prompt", "hello", "--max-queue-size", "0"], "queue"),
        (vec!["--model", "test", "--prompt", "hello", "--request-timeout", "abc"], "timeout"),
        (vec!["--model", "test", "--prompt", "hello", "--worker-threads", "0"], "thread"),
        (vec!["--model", "test", "--prompt", "hello", "--max-sessions", "-5"], "session"),
        (vec!["--model", "test", "--prompt", "hello", "--session-timeout", "abc"], "timeout"),
        (vec!["--model", "test", "--prompt", "hello", "--temperature", "abc"], "temperature"),
        (vec!["--model", "test", "--prompt", "hello", "--top-p", "1.5"], "top-p"),
    ];
...
async fn test_cli_edge_case_values() {
    let edge_cases = vec![
        // Maximum values
        vec!["--model", "test", "--prompt", "hello", "--limit", "4294967295"], // u32 max
        vec!["--model", "test", "--prompt", "hello", "--batch-size", "8192"],
        vec!["--model", "test", "--prompt", "hello", "--max-queue-size", "1000"],
        vec!["--model", "test", "--prompt", "hello", "--request-timeout", "3600"],
        vec!["--model", "test", "--prompt", "hello", "--worker-threads", "16"],
        vec!["--model", "test", "--prompt", "hello", "--max-sessions", "10000"],
        vec!["--model", "test", "--prompt", "hello", "--session-timeout", "86400"],
        vec!["--model", "test", "--prompt", "hello", "--temperature", "1.0"],
        vec!["--model", "test", "--prompt", "hello", "--top-p", "1.0"],
        
        // Minimum values
        vec!["--model", "test", "--prompt", "hello", "--limit", "1"],
        vec!["--model", "test", "--prompt", "hello", "--batch-size", "1"],
        vec!["--model", "test", "--prompt", "hello", "--max-queue-size", "1"],
        vec!["--model", "test", "--prompt", "hello", "--request-timeout", "1"],
        vec!["--model", "test", "--prompt", "hello", "--worker-threads", "1"],
        vec!["--model", "test", "--prompt", "hello", "--max-sessions", "1"],
        vec!["--model", "test", "--prompt", "hello", "--session-timeout", "1"],
        vec!["--model", "test", "--prompt", "hello", "--temperature", "0.0"],
    ...
    for args in edge_cases {
        ...
        if !stderr.contains("Model loading failed") && 
           ...
           !stderr.contains("Backend already initialized") {
            ...
            assert!(
                stderr.contains("error") || stderr.contains("validation") || 
...
async fn test_cli_prompt_variations() {
    ...
    for prompt in prompts {
        ...
        assert!(
            !stderr.contains("invalid prompt") && 
            !stderr.contains("prompt parsing"),
